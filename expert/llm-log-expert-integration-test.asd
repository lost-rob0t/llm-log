(asdf:defsystem #:llm-log-expert-integration-test
  ...
  :components ((:module "tests"
                ...
                :components ((:file "integration-package")
                             ...
                             (:file "task-rollup-restart-red")
                             (:file "task-retry-attempt-red")
                             (:file "task-retry-legacy-replay-red")
                             (:file "task-usage-breakdown-red")
                             (:file "task-classification-breakdown-red")
